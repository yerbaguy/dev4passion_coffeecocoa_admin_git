...
function showInfo() {
    ...
    getData.forEach((element, index) => {
        let createElement = `<tr class="employeeDetails">
            ...
            <td>
                <button class="btn btn-success" onclick="readInfo('${element.picture}', '${element.coffee_roasted_product_description}', '${element.employeeAge}', '${element.employeeCity}', '${element.employeeEmail}', '${element.employeePhone}', '${element.employeePost}', '${element.startDate}')" data-bs-toggle="modal" data-bs-target="#readData"><i class="bi bi-eye"></i></button>

                <button class="btn btn-primary" onclick="editInfo(${index}, '${element.picture}', '${element.coffee_roasted_product_description}', '${element.employeeAge}', '${element.employeeCity}', '${element.employeeEmail}', '${element.employeePhone}', '${element.employeePost}', '${element.startDate}')" data-bs-toggle="modal" data-bs-target="#userForm"><i class="bi bi-pencil-square"></i></button>
...
function readInfo(pic, coffee_roasted_product_description, age, city, email, phone, post, sDate) {
    document.querySelector('.showImg').src = pic,
...
function editInfo(index, pic, Coffee_Roasted_Product_Description, Age, City, Email, Phone, Post, Sdate) {
    isEdit = true
    editId = index
    imgInput.src = pic
