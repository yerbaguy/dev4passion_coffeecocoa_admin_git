...
// coffee_roasted_product_description
...
function showInfo() {
    ...
    getData.forEach((element, index) => {
        let createElement = `<tr class="employeeDetails">
            ...
            <td>${element.coffee_roasted_farm}</td>
            <td>${element.coffee_roasted_farmer}</td>
            <td>${element.coffee_roasted_roaster}</td>
            <td>${element.employeePhone}</td>
            <td>${element.employeePost}</td>
            <td>${element.startDate}</td>
            ...
            <td>
                <button class="btn btn-success" onclick="readInfo('${element.picture}', '${element.coffee_roasted_product_description}', '${element.coffee_roasted_farm}', '${element.coffee_roasted_farmer}', '${element.coffee_roasted_roaster}', '${element.employeePhone}', '${element.employeePost}', '${element.startDate}')" data-bs-toggle="modal" data-bs-target="#readData"><i class="bi bi-eye"></i></button>

                <button class="btn btn-primary" onclick="editInfo(${index}, '${element.picture}', '${element.coffee_roasted_product_description}', '${element.coffee_roasted_farm}', '${element.coffee_roasted_farmer}', '${element.coffee_roasted_roaster}', '${element.employeePhone}', '${element.employeePost}', '${element.startDate}')" data-bs-toggle="modal" data-bs-target="#userForm"><i class="bi bi-pencil-square"></i></button>
...
function readInfo(pic, coffee_roasted_product_description, coffee_roasted_farm, coffee_roasted_farmer, coffee_roasted_roaster, phone, post, sDate) {
    document.querySelector('.showImg').src = pic,
...
function editInfo(index, pic, Coffee_Roasted_Product_Description, Coffee_Roasted_Farm, Coffee_Roasted_Farmer, Coffee_Roasted_Roaster, Phone, Post, Sdate) {
    isEdit = true
    editId = index
    imgInput.src = pic
